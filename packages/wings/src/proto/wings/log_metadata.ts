...
//   protoc               unknown
// source: wings/log_metadata.proto
...
function createBaseCommitFolioRequest(): CommitFolioRequest {
  return { namespace: "", fileRef: "", pages: [] };
}

export const CommitFolioRequest = {
  encode(message: CommitFolioRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.pages) {
      CommitPageRequest.encode(v!, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): CommitFolioRequest {
...
function createBaseCommitPageRequest(): CommitPageRequest {
  return {
    ...
    partition: undefined,
    numMessages: 0,
    offsetBytes: BigInt("0"),
    batchSizeBytes: BigInt("0"),
    batches: [],
  };
}

export const CommitPageRequest = {
  encode(message: CommitPageRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.topic !== "") {
      writer.uint32(10).string(message.topic);
    }
    if (message.partition !== undefined) {
      PartitionValue.encode(message.partition, writer.uint32(18).fork()).ldelim();
    }
    if (message.numMessages !== 0) {
      writer.uint32(24).uint32(message.numMessages);
    }
    if (message.offsetBytes !== BigInt("0")) {
      ...
      writer.uint32(32).uint64(message.offsetBytes.toString());
    }
    if (message.batchSizeBytes !== BigInt("0")) {
      ...
      writer.uint32(40).uint64(message.batchSizeBytes.toString());
    }
    for (const v of message.batches) {
      CommitBatchRequest.encode(v!, writer.uint32(50).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): CommitPageRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.offsetBytes = longToBigint(reader.uint64() as Long);
          continue;
        case 5:
          if (tag !== 40) {
            break;
          ...
          message.batchSizeBytes = longToBigint(reader.uint64() as Long);
          continue;
        case 6:
          if (tag !== 50) {
            break;
  ...
  fromJSON(object: any): CommitPageRequest {
    return {
      ...
      offsetBytes: isSet(object.offsetBytes) ? BigInt(object.offsetBytes) : BigInt("0"),
      batchSizeBytes: isSet(object.batchSizeBytes) ? BigInt(object.batchSizeBytes) : BigInt("0"),
  ...
  fromPartial<I extends Exact<DeepPartial<CommitPageRequest>, I>>(object: I): CommitPageRequest {
    ...
    message.offsetBytes = object.offsetBytes ?? BigInt("0");
    message.batchSizeBytes = object.batchSizeBytes ?? BigInt("0");
...
function createBaseCommitBatchRequest(): CommitBatchRequest {
  return { timestamp: undefined, numMessages: 0 };
}

export const CommitBatchRequest = {
  encode(message: CommitBatchRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CommitBatchRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CommitFolioResponse = {
  encode(message: CommitFolioResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.pages) {
      CommitPageResponse.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): CommitFolioResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseCommitPageResponse(): CommitPageResponse {
  return { topic: "", partition: undefined, batches: [] };
}

export const CommitPageResponse = {
  encode(message: CommitPageResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.topic !== "") {
      writer.uint32(10).string(message.topic);
    }
    if (message.partition !== undefined) {
    ...
    for (const v of message.batches) {
      CommittedBatch.encode(v!, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): CommitPageResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseGetLogLocationRequest(): GetLogLocationRequest {
  return { topic: "", partition: undefined, deadline: undefined, location: undefined };
}

export const GetLogLocationRequest = {
  encode(message: GetLogLocationRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.topic !== "") {
      writer.uint32(10).string(message.topic);
    }
    if (message.partition !== undefined) {
    ...
    switch (message.location?.$case) {
      case "offset":
        ...
        writer.uint32(32).uint64(message.location.offset.toString());
        break;
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): GetLogLocationRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.location = { $case: "offset", offset: longToBigint(reader.uint64() as Long) };
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromPartial<I extends Exact<DeepPartial<GetLogLocationRequest>, I>>(object: I): GetLogLocationRequest {
    ...
    if (
      object.location?.$case === "offset" && object.location?.offset !== undefined && object.location?.offset !== null
    ) {
...
export const GetLogLocationResponse = {
  encode(message: GetLogLocationResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    switch (message.location?.$case) {
      case "folioLocation":
        FolioLocation.encode(message.location.folioLocation, writer.uint32(10).fork()).ldelim();
        break;
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): GetLogLocationResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<GetLogLocationResponse>, I>>(object: I): GetLogLocationResponse {
    const message = createBaseGetLogLocationResponse() as any;
    if (
      object.location?.$case === "folioLocation" &&
...
function createBaseFolioLocation(): FolioLocation {
  return { fileRef: "", offsetBytes: BigInt("0"), sizeBytes: BigInt("0"), batches: [] };
}

export const FolioLocation = {
  encode(message: FolioLocation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.fileRef !== "") {
    ...
    if (message.offsetBytes !== BigInt("0")) {
      ...
      writer.uint32(16).uint64(message.offsetBytes.toString());
    }
    ...
    for (const v of message.batches) {
      CommittedBatch.encode(v!, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): FolioLocation {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseListPartitionsRequest(): ListPartitionsRequest {
  return { topic: "", pageSize: undefined, pageToken: undefined };
}

export const ListPartitionsRequest = {
  encode(message: ListPartitionsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.topic !== "") {
      writer.uint32(10).string(message.topic);
    }
...
function createBaseListPartitionsResponse(): ListPartitionsResponse {
  return { partitions: [], nextPageToken: undefined };
}

export const ListPartitionsResponse = {
  encode(message: ListPartitionsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.partitions) {
      PartitionMetadata.encode(v!, writer.uint32(10).fork()).ldelim();
    }
...
function createBasePartitionMetadata(): PartitionMetadata {
  return { value: undefined, endOffset: undefined };
}

export const PartitionMetadata = {
  encode(message: PartitionMetadata, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.value !== undefined) {
      PartitionValue.encode(message.value, writer.uint32(10).fork()).ldelim();
    }
    if (message.endOffset !== undefined) {
      LogOffset.encode(message.endOffset, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): PartitionMetadata {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CommittedBatch = {
  encode(message: CommittedBatch, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    switch (message.result?.$case) {
      case "accepted":
        CommittedBatch_Accepted.encode(message.result.accepted, writer.uint32(10).fork()).ldelim();
        break;
      case "rejected":
        CommittedBatch_Rejected.encode(message.result.rejected, writer.uint32(18).fork()).ldelim();
        break;
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): CommittedBatch {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<CommittedBatch>, I>>(object: I): CommittedBatch {
    const message = createBaseCommittedBatch() as any;
    if (
      object.result?.$case === "accepted" && object.result?.accepted !== undefined && object.result?.accepted !== null
    ) {
      message.result = { $case: "accepted", accepted: CommittedBatch_Accepted.fromPartial(object.result.accepted) };
    }
    if (
      object.result?.$case === "rejected" && object.result?.rejected !== undefined && object.result?.rejected !== null
    ) {
...
export const CommittedBatch_Accepted = {
  encode(message: CommittedBatch_Accepted, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CommittedBatch_Accepted {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CommittedBatch_Rejected = {
  encode(message: CommittedBatch_Rejected, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.numMessages !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CommittedBatch_Rejected {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseLogOffset(): LogOffset {
  return { offset: BigInt("0"), timestamp: undefined };
}

export const LogOffset = {
  encode(message: LogOffset, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): LogOffset {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PartitionValue = {
  encode(message: PartitionValue, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    switch (message.value?.$case) {
      case "nullValue":
        Empty.encode(message.value.nullValue, writer.uint32(10).fork()).ldelim();
        break;
      case "int8Value":
      ...
      case "int64Value":
        ...
        writer.uint32(40).int64(message.value.int64Value.toString());
        break;
      case "uint8Value":
      ...
      case "uint64Value":
        ...
        writer.uint32(72).uint64(message.value.uint64Value.toString());
        break;
      case "stringValue":
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PartitionValue {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          message.value = { $case: "int64Value", int64Value: longToBigint(reader.int64() as Long) };
          continue;
        case 6:
          if (tag !== 48) {
            break;
        ...
        case 9:
          ...
          message.value = { $case: "uint64Value", uint64Value: longToBigint(reader.uint64() as Long) };
          continue;
        case 10:
          if (tag !== 82) {
            break;
  ...
  fromPartial<I extends Exact<DeepPartial<PartitionValue>, I>>(object: I): PartitionValue {
    const message = createBasePartitionValue() as any;
    if (
      object.value?.$case === "nullValue" && object.value?.nullValue !== undefined && object.value?.nullValue !== null
    ) {
      message.value = { $case: "nullValue", nullValue: Empty.fromPartial(object.value.nullValue) };
    }
    if (
      object.value?.$case === "int8Value" && object.value?.int8Value !== undefined && object.value?.int8Value !== null
    ) {
      message.value = { $case: "int8Value", int8Value: object.value.int8Value };
    }
    if (
      object.value?.$case === "int16Value" &&
      object.value?.int16Value !== undefined &&
      object.value?.int16Value !== null
    ) {
    ...
    if (
      object.value?.$case === "uint8Value" &&
      object.value?.uint8Value !== undefined &&
      object.value?.uint8Value !== null
    ) {
      message.value = { $case: "uint8Value", uint8Value: object.value.uint8Value };
    }
    if (
      object.value?.$case === "uint16Value" &&
      object.value?.uint16Value !== undefined &&
      object.value?.uint16Value !== null
    ) {
